...
### Roblox_Parental
Ved hvert release må versjonsnummeret oppdateres **to steder** (alle må være like):
1. `Roblox_Parental/config.yaml` — linje 3: `version:`
2. `Roblox_Parental/Dockerfile` — `ENV ADDON_VERSION=` og `io.hass.version` label
