...
MERKE_INFO = {
    ...
    "adria": {
        ...
        "kortbeskrivelse": "Slovenisk merke grunnlagt 1965, nå Europas fjerde største bobil-produsent. Solid pris/kvalitet-ratio med sterk nyttelast på mange modeller. Del av Adria Mobil-konsernet.",
    ...
    "knaus": {
        ...
        "segment_label": "Mellomsjikt",
        "opprinnelse": "🇩🇪 Tyskland",
        "kortbeskrivelse": "Stor tysk produsent grunnlagt 1960 i Jandelsbrunn. Del av Knaus Tabbert Group (børsnotert 2021). Bredt sortiment fra budsjett (Weinsberg) til premium. God allrounder med solid norsk markedsposisjon.",
        ...
        "styrker": [
            ...
            "Fornuftig pris for tysk kvalitet og konstruksjon",
            "Van TI-serien kjent for fremragende allværsegenskaper",
            "Solid konstruksjon med god isolasjon på nyere modeller",
        ],
        "svakheter": [
            "Litt anonymt design — mangler Bürstners eleganse og Hymers prestisje",
    ...
    "dethleffs": {
        ...
        "segment_label": "Mellomsjikt",
        "opprinnelse": "🇩🇪 Tyskland",
        "kortbeskrivelse": "Europas eldste bobil-produsent, grunnlagt 1931 i Isny im Allgäu. Del av Erwin Hymer Group. Kjent for praktiske løsninger, romslige planløsninger og konservativt men holdbart design. Stor og lojal kundebase i Skandinavia.",
        ...
        "svakheter": [
            ...
            "Interiørdesign oppleves av mange som utdatert sammenlignet med Bürstner eller Hobby",
        ],
        "kjente_problemer": [
    ...
    "sunlight": {
        ...
        "segment_label": "Budsjett",
        "opprinnelse": "🇩🇪 Tyskland",
        "kortbeskrivelse": "Tysk budsjettmerke grunnlagt 1986, søsterselskap av Dethleffs under Erwin Hymer Group. Produseres i Wilsdruff ved Dresden. Posisjonert som et rimeligere alternativ til Dethleffs, men med noe enklere materialer.",
        ...
        "styrker": [
            "Lav pris — typisk 15–25% billigere enn Dethleffs i samme segment",
            "Produsert i Tyskland — bedre konstruksjonskvalitet enn italienske budsjettmerker",
            "Enkle og ryddige planløsninger, lett å orientere seg i",
            "Van 60-serien: kompakt og lett, passer godt for par",
        ],
        "svakheter": [
            "Enklere materialer enn Dethleffs — tydelig i interiørfinish og benkeplater",
            "Lavere verdiholding enn Dethleffs, til tross for samme konsern",
            "Litt tynnere veggkonstruksjon enn mellomsjiktet",
        ],
        "kjente_problemer": [
        ...
        "kjopstips": "Van 60-serien fra 2018+ er trygge kjøp og holder godt. Sjekk pakninger rundt sidevindu på eldre modeller. God start for de som vil ha tysk merke til lavest mulig pris.",
        "typiske_kjopere": "Budsjettbevisste par eller småfamilier som vil ha tysk opprinnelse og Hymer-konsernets reservedelsdekning til lavest mulig pris.",
    },
    "carado": {
        "visningsnavn": "Carado",
        "segment": "budget",
        "segment_label": "Budsjett",
        "opprinnelse": "🇩🇪 Tyskland",
        "kortbeskrivelse": "Tysk budsjettmerke under Erwin Hymer Group, produsert i Neustadt an der Donau. Søstermerke til Sunlight, men med noe annerledes design og modellutvalg. Kjent for fornuftig kvalitet til lav pris.",
        ...
        "styrker": [
            "God verdi for pengene — Hymer-konsernets kvalitetskontroll til budsjett-pris",
            "Del av Hymer-konsernet — reservedeler og servicenettverk tilgjengelig lenge",
            "Ryddig el-opplegg arvet fra Hymer-tradisjonen",
            "T-klassen tilbyr mange planløsninger for prisen",
        ],
        "svakheter": [
            "Ikke samme bygningskvalitet som Hymer eller Laika — tydelig i detaljfinish",
            "Begrenset antall norske forhandlere",
            "Lav verdiholding sammenlignet med merker i mellomsjiktet",
        ],
        "kjente_problemer": [
            ...
            "Generelt: plastbeslag og skuffebeslag i kjøkken er budsjett-standard og kan knekke",
        ],
        "kjopstips": "T 338 og T 390 er de mest solgte modellene brukt — enkle å finne deler til. Sjekk frontvinduspakning nøye på pre-2016 modeller. Fint alternativ for de som vil ha Hymer-konsernets dekning til lav pris.",
        "typiske_kjopere": "Prissensitive kjøpere som vil ha tysk opprinnelse og trygg reservedelsdekning, men ikke har budsjett til Hymer eller Bürstner.",
    },
    "pilote": {
        "visningsnavn": "Pilote",
        "segment": "mid",
    ...
    "chausson": {
        ...
        "segment_label": "Mellomsjikt",
        "opprinnelse": "🇫🇷 Frankrike",
        "kortbeskrivelse": "Stor fransk produsent grunnlagt 1949, nå del av Trigano-gruppen. Kjent for Flash-serien med ekstra bredt karosseri (233 cm) som gir usedvanlig god bredde innvendig. Populær i Frankrike og Sør-Europa.",
        ...
        "styrker": [
            ...
            "God nyttelast på Flash-serien — ofte 450–550 kg",
            "Rimelig innkjøpspris for størrelsen",
        ...
        "typiske_kjopere": "Familier som prioriterer innvendig plass og bredde fremfor merkenavn og norsk servicedekning.",
    },
    "laika": {
        "visningsnavn": "Laika",
        "segment": "premium",
    ...
    "malibu": {
        ...
        "segment_label": "Premium",
        "opprinnelse": "🇩🇪 Tyskland",
        "kortbeskrivelse": "Tysk spesialist på Van-klassen (campervan på Fiat Ducato), grunnlagt 2010 i Wohnmobilwerk Wissmar. Kjent for innovative løsninger, høy byggkvalitet og smart utnyttelse av det kompakte formatet. Ingen fullintegrerte modeller.",
